...
export const Comments = ({comment}) => {
    ...
    return (
        <section className={commentsStyles['comments']}>
            ...
            {commAuthorCheck
                    ? <>
                        <Link to={`/details/comment/edit/${comment._id}`} className={commentsStyles['edit']}>Edit</Link>
                        <Link to={`/details/comment/delete/${comment._id}`} className={commentsStyles['del']} comment={comment}>Delete</Link>
                    </>
                    : null
                }
